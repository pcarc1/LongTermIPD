...
data_inla_plz2_delta <- list(
  ...
  vacc_rate = plz2_db_delta$vacc_rate,
  vacc_cat = plz2_db_delta$vacc_cat,
  nyeargroup = plz2_db_delta$nyeargroup,
  vacc_rate_d = plz2_db_delta$vacc_rate_d,
  vacc_cat_d = plz2_db_delta$vacc_cat_d
)
```
...
f9 <- cases_19F ~ 1 + f(idarea, model = "bym2", graph = g_plz2) + f(nyeargroup, model = "rw2") + f(vacc_cat_d, model = "rw2", constr = FALSE, extraconstr = extraconstr2)
...
vacc_result9 <- result9$summary.random$vacc_cat
