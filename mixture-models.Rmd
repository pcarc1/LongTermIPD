...
## Mixture model with PCV-13 -- delta centered around 1, simpler binary var
...
## Mixture model with PCV-13 -- using delta[j] as serotype intercept
...
## Mixture model with PCV-13 -- removing epsilon to force clustering
