...
```{r, eval = FALSE}
params9 <- c("alpha1", "epsilon1", "delta1", "beta1", "beta2", "tau_beta1", "lambda", "grp", "logit_pi")

mod9_postsamp <- coda.samples(mod9, params9, n.iter = 10000)
...
```{r, eval = FALSE}
mod10_postsamp <- coda.samples(mod10, params9, n.iter = 10000)
