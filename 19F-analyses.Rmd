...
## IPD cases 2017-2018 / IPD cases circa introduction of PCV-13
...
data_19F <- read_csv("data/data_19F.csv") |> 
  mutate(ratio = N_IPD_comp/N_IPD_base,
         schedule = factor(schedule),
         vax = factor(case_when(!is.na(year_pcv10) & !is.na(year_pcv13) ~ "both",
                                !is.na(year_pcv10) ~ "pcv10",
                                !is.na(year_pcv13) ~ "pcv13"))) |> 
  rowwise() |> 
  mutate(mean_cov = mean(c(coverage_2011, coverage_2012, coverage_2013, coverage_2014, coverage_2015, coverage_2016, coverage_2017, coverage_2018), na.rm = TRUE))
```
...
Shapefiles from: https://www.suche-postleitzahl.org/downloads
